"""TC010 Regression — DocuChat Chat: Validate Chat Initialization with 5-mini CRT model and Code Assistant - Python.

Test Case Name : TC010_Regression_DocuChat_Chat_Validate Chat Initialization with 5-mini CRT model and Code Assistant - Python
...
async def _run_tc_flow(
    ...
    """Execute all 14 steps for TC010 (Code Assistant - Python, 5-mini CRT model)."""
    ...
    await _run_step(
        ...
        _verify_long_query_response(chat_page, tc_key="tc010"),
        tc_name, page,
    )
    await _run_step(
        8,
...
async def test_tc010_regression_docuchat_chat_validate_chat_initialization_with_5mini_crt_model_and_code_assistant_python(
    docuchat_context,
):
    """TC010 — Validate Chat Initialization with 5-mini CRT model and Code Assistant - Python."""
    _td = _get_chat_inputs("tc010")
    await _run_tc_flow(
        docuchat_context,
        query=_td.query,
        tc_name="TC010",
