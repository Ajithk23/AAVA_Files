"""TC013 Regression — DocuChat Chat: Validate Document validations with 5.1 mini CRT model and Chat Type as Chat with Documents.

Test Case Name : TC013_Regression_DocuChat_Chat_Validate Document validations with 5.1 mini CRT model and Chat Type as Chat with Documents
...
# TC013 identifier — references the test name for traceability
_TC013_NAME = (
    "TC013_Regression_DocuChat_Chat_Validate Document validations with 5.1 mini CRT "
...
async def _run_tc_flow(
    ...
    """Execute all 10 steps for TC013.
...
async def test_tc013_regression_docuchat_chat_validate_document_validations_with_51mini_crt_model_and_chat_with_documents(
    docuchat_context,
):
    """TC013 — Validate Document validations with 5.1 mini CRT model and Chat Type as Chat with Documents."""
    _td = _get_chat_inputs("tc013")
    await _run_tc_flow(
        docuchat_context,
        query=_td.query,
        tc_name="TC013",
