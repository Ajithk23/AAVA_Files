"""TC004 / TC005 / TC006 Regression — DocuChat Chat: Validate Chat Initialization with Chat with Documents chat type.
...
# file_prefix matches the pre-uploaded document name in the QA environment.
_MODEL_VARIANTS = [
    pytest.param(
        "5-mini CRT",
        "TC004",
...
async def _run_tc_flow(
    ...
    """Execute all 14 steps for Chat with Documents Initialization (TC004 / TC005 / TC006).
...
async def test_chat_initialization_chat_with_documents(
    ...
    """Validate Chat Initialization with Chat with Documents chat type across all model variants."""
