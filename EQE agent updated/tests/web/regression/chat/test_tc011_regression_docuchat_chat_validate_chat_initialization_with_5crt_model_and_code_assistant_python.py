"""TC011 Regression — DocuChat Chat: Validate Chat Initialization with 5 CRT model and Code Assistant - Python.

Test Case Name : TC011_Regression_DocuChat_Chat_Validate Chat Initialization with 5 CRT model and Code Assistant - Python
...
async def _run_tc_flow(
    ...
    """Execute all 14 steps for TC011 (Code Assistant - Python, 5 CRT model)."""
    ...
    await _run_step(
        ...
        _verify_long_query_response(chat_page, tc_key="tc011"),
        tc_name, page,
    )
    await _run_step(
        8,
...
async def test_tc011_regression_docuchat_chat_validate_chat_initialization_with_5crt_model_and_code_assistant_python(
    docuchat_context,
):
    """TC011 — Validate Chat Initialization with 5 CRT model and Code Assistant - Python."""
    _td = _get_chat_inputs("tc011")
    await _run_tc_flow(
        docuchat_context,
        query=_td.query,
        tc_name="TC011",
