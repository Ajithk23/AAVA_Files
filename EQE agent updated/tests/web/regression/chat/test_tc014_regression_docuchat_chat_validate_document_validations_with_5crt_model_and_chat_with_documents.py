"""TC014 Regression — DocuChat Chat: Validate Document validations with 5 CRT model and Chat Type as Chat with Documents.

Test Case Name : TC014_Regression_DocuChat_Chat_Validate Document validations with 5 CRT model and Chat Type as Chat with Documents
...
# TC014 identifier — references the test name for traceability
_TC014_NAME = (
    "TC014_Regression_DocuChat_Chat_Validate Document validations with 5 CRT "
...
async def _run_tc_flow(
    ...
    """Execute all 10 steps for TC014.
...
async def test_tc014_regression_docuchat_chat_validate_document_validations_with_5crt_model_and_chat_with_documents(
    docuchat_context,
):
    """TC014 — Validate Document validations with 5 CRT model and Chat Type as Chat with Documents."""
    _td = _get_chat_inputs("tc014")
    await _run_tc_flow(
        docuchat_context,
        query=_td.query,
        tc_name="TC014",
